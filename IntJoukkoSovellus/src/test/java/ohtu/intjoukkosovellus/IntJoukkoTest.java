...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.onkoJoukossaJoLuku(10));
        assertFalse(joukko.onkoJoukossaJoLuku(5));
        assertTrue(joukko.onkoJoukossaJoLuku(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.onkoJoukossaJoLuku(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.onkoJoukossaJoLuku(11));
        joukko.poista(11);
        assertFalse(joukko.onkoJoukossaJoLuku(11));
